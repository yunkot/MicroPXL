...
uses
  Classes, SysUtils, FileUtil, Forms, Controls, Graphics, Dialogs, PXL.Types, PXL.Timing, PXL.ImageFormats,
  PXL.Surfaces, PXL.Canvas, PXL.Fonts, PXL.Surfaces.LCL;
...
uses
  PXL.Classes, PXL.ImageFormats.FCL;
...
begin
  ...
  RenderScene;
  DrawSurfaceToCanvas(FSurface, Canvas, 0, 0);
